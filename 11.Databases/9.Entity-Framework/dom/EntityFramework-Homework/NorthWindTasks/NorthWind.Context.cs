...
namespace NorthWindTasks
{
    ...
    public partial class NORTHWNDEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> usp_FindTotalIncome(Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, string companyName)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("usp_FindTotalIncome", startDateParameter, endDateParameter, companyNameParameter);
        }
    }
}
