<%@ Page Title="" Language="C#" MasterPageFile="~/Spanish/Spanish.master" AutoEventWireup="true" CodeBehind="About_Sp.aspx.cs" Inherits="_2.NestedMasterPages.Spanish.About_Sp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="content" runat="server">
    <section class="panel panel-info">
        <header class="panel-heading">
            Acerca de Heisenberg:
        </header>
